...
node src/bin/validate-edit-scope.js --workspace-root E:/xile-workspace/next-app --data-root E:/xile-workspace/codex-tools/project-memory-data --task "补齐发布质量门禁" --known-file package.json --known-file .github/workflows/ci.yml --changed-file package.json --changed-file .github/workflows/ci.yml --json
